...
class _MyAddPageState extends State<MyAddPage> {
  ...
  Future getImage() async {
    AlertDialog alerta = new AlertDialog(
      content: Text('Chọn nơi bạn muốn chụp ảnh từ'),
      title: Text('Chọn ảnh'),
      actions: <Widget>[
        FlatButton(
          onPressed: () {
          ...
          child: Row(
            children: <Widget>[Text('Máy ảnh'), Icon(Icons.camera)],
          ),
        ),
        FlatButton(
          onPressed: () {
          ...
          child: Row(
            children: <Widget>[Text('Bộ sưu tập'), Icon(Icons.image)],
          ),
        )
      ],
    );
  ...
  void _enviar() {
    if (_validarlo()) {
      ...
      auth.currentUser().then((onValue) {
        ...
        if (_foto != null) {
          ...
          Firestore.instance
              ...
              .then((value) => Navigator.of(context).pop())
              .catchError(
                  (onError) => print('Lỗi đăng kí người dùng'));
          _isInAsyncCall = false;
        }
      ...
      print('Đối tượng không có giá trị');
    }
  }
